...
<pre>
    <p><span>#</span> <span>To clone the project / repository, type the following command in the terminal:</span> <br>$ git clone</p>
    <p><span>#</span> <span>To run the server, enter the project's root folder and type the following command in the terminal inside that folder:</span> <br>$ run node dev</p>
</pre>
